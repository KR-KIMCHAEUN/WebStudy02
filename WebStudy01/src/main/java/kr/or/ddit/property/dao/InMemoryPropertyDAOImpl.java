...
import java.util.stream.Collectors;import com.fasterxml.jackson.databind.deser.impl.PropertyValue;
...
//	}
	...
	@Override
	public int updateProperty(PropertyVO modifypProp) {
		if(properties.containsKey(modifypProp.getPropertyName())) {
			properties.setProperty(modifypProp.getPropertyName(), modifypProp.getPropertyValue());
			return 1;
		}else {
			return 0;
		}
